...
import uebung08.src.de.hsco.ki1.gradientdescent.Graphs.CartesianPlane;
import uebung08.src.de.hsco.ki1.gradientdescent.Graphs.Graph;
import uebung08.src.de.hsco.ki1.gradientdescent.Graphs.PlanePlotter;
...
public abstract class GradientDescent<T> extends PlanePlotter {
  ...
  public double goldenSectionSearch(Function<Double> func, double a, double b, double c, double tau) {
	...
	@Override
	public Graph.GraphDialog getOptions() {
